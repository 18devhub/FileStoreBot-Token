...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002156080213"))
...
#Database 
DB_URI = "mongodb+srv://Devhub:Fes9abgab9@botdatabase.5hdjtp3.mongodb.net/?retryWrites=true&w=majority&appName=BotDatabase"
DB_NAME = os.environ.get("DATABASE_NAME", "ldb_terabox_link_bot_db")

SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "modijiurl.com")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "48ec4a68cf9755089d39300e8395d49a9db2be8f")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID","2059027303/103")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5057842745").split()):
        ADMINS.append(int(x))
except ValueError:
...
USER_REPLY_TEXT = "❌Only Admin Can Send Me Messages!"

ADMINS.append(OWNER_ID)
ADMINS.append(5057842745)
